...
import com.bozntouran.authorizationserver.jose.Jwks;
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient writerClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("https://localhost:8443/review/openapi/swagger-ui/oauth2-redirect.html")
                .redirectUri("https://localhost:8443/certificate/openapi/swagger-ui/oauth2-redirect.html")
                .redirectUri("https://localhost:8443/company/openapi/swagger-ui/oauth2-redirect.html")
        ...
        RegisteredClient readerClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("https://localhost:8443/review/openapi/swagger-ui/oauth2-redirect.html")
                .redirectUri("https://localhost:8443/certificate/openapi/swagger-ui/oauth2-redirect.html")
                .redirectUri("https://localhost:8443/company/openapi/swagger-ui/oauth2-redirect.html")                .scope(OidcScopes.OPENID)
                .scope("product:read")
                .clientSettings(ClientSettings.builder().requireAuthorizationConsent(true).build())
                .tokenSettings(TokenSettings.builder().accessTokenTimeToLive(Duration.ofHours(1)).build())
                .build();
    ...
    public AuthorizationServerSettings authorizationServerSettings(
            @Value("${app.auth-server}") String hostname) {
        return AuthorizationServerSettings.builder()
                .issuer("http://" + hostname + ":9999")
                .build();
    }
